...
func RouteDigest(digest *chi.Mux, firebaseAuth *firebase.App) *chi.Mux{
	...
	rAdminProducts := adminendpoints.InstanceAdminProductRoutes()
	...
	digest.Group(func(digest chi.Router){
		...
		digest.Post("/products/", rAdminProducts.CreateProduct)
		digest.Post("/products/{ProductID}/variation", rAdminProducts.CreateVariation)
		digest.Post("/products/{ProductID}/variation/{VariationID}/size", rAdminProducts.CreateProductSize)
		digest.Patch("/products/{ProductID}",rAdminProducts.EditProduct)
		digest.Patch("/variation/{VariationID}",rAdminProducts.EditVariation)
		digest.Delete("/variation/{VariationID}",rAdminProducts.DeleteVariation)
		digest.Post("/variation/{VariationID}/attribute",rAdminProducts.AddAttribute)
		digest.Patch("/variation/{VariationID}/attribute/{AttributeName}",rAdminProducts.UpdateAttribute)
		digest.Delete("/variation/{VariationID}/attribute/{AttributeName}",rAdminProducts.DeleteAttribute)
		digest.Delete("/product-size/{ProductSizeID}",rAdminProducts.DeleteProductSize)
		digest.Put("/product-size/{ProductSizeID}",rAdminProducts.EditProductSize)
		...
		digest.Get("/category/tree", rAdminCategories.ReturnCategoryTree)
		digest.Delete("/category/prime/{CatPrimeID}",rAdmin.DeletePrimeCategory)
		digest.Delete("/category/sub/{CatSubID}",rAdmin.DeleteSubCategory)
		digest.Delete("/category/final/{CatFinalID}",rAdmin.DeleteFinalCategory)
